  ...
  return (
    <nav className="navbar"> 
        ...
        <div className="desktopMenu">
            ...
            <Link activeClass='active' to='education' spy={true} smooth={true} offset={-30} duration={500} className="desktopMenuListItem"> About </Link>
        </div>
        ...
        <div className="navMenu" style={{display: showMenu? 'flex' : 'none'}}>
            ...
            <Link activeClass='active' to='contact' spy={true} smooth={true} offset={-30} duration={500} className="ListItem" onClick={()=> setShowMenu(false)}> About </Link>
